...
const Contact = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md sm:text-center">
          ...
          <p class="mx-auto mb-8 max-w-2xl  text-gray-800 md:mb-12 sm:text-xl ">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
          <form action="#">
              <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div class="relative w-full">
                      ...
                      <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-blue-200/80 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg placeholder-black  " placeholder="Enter your email" type="email" id="email" required=""/>
                  </div>
                  <div>
                      ...
                      bg-blue-300/30 hover:bg-blue-400/40 focus:ring-blue-500">Subscribe</button>
                  </div>
              </div>
